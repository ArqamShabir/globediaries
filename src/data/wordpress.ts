...
export const fetchWordPressCountries = async (): Promise<WordPressCountry[]> => {
  try {
    ...
    const response = await fetch(`${WORDPRESS_BASE_URL}/posts?categories=5&per_page=50&_embed`);
...
export const fetchWordPressCities = async (): Promise<WordPressCity[]> => {
  try {
    ...
    const response = await fetch(`${WORDPRESS_BASE_URL}/posts?categories=6&per_page=100&_embed`);
...
export const fetchWordPressCityBySlug = async (slug: string): Promise<WordPressCity | null> => {
  try {
    const response = await fetch(`${WORDPRESS_BASE_URL}/posts?slug=${slug}&categories=6&_embed`);
